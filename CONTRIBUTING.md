...
Bug reports and feature requests for 4chan-neXT are tracked at **https://github.com/TuxedoTako/4chan-xt/issues?q=is%3Aopen+sort%3Aupdated-desc**.
...
7. Test if the bug occurs using the **native extension** with 4chan-neXT disabled. If it does, it's likely a problem with 4chan or your browser rather than with 4chan X.
...
- Clone 4chan-neXT: `git clone https://github.com/TuxedoTako/4chan-xt.git`
